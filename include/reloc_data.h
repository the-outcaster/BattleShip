...
/* 4233 symbols from the vendored table, 1774 extra stubs from src/. */
...
#define llDededeMainFileID (*(intptr_t*)0x0)
#define llDededeCharacterFileID (*(intptr_t*)0x0)
#define llDededeShieldPoseFileID (*(intptr_t*)0x0)
...
#define llFTCommonMovesetFileID (*(intptr_t*)0) /* STUBBED */
...
#define llITBonus1ObjectHeaderFileID (*(intptr_t*)0) /* STUBBED */
#define llKirbySpecial1FileID (*(intptr_t*)0) /* STUBBED */
#define llMNTitleUnknownAnimJoint (*(intptr_t*)0) /* STUBBED */
#define llMNTitleUnknownDObjDesc (*(intptr_t*)0) /* STUBBED */
#define llStagePupupuFile2FileID (*(intptr_t*)0) /* STUBBED */
